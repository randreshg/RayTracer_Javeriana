...
--synthesis_resources = lpm_compare 4 reg 1 
 ...
 ENTITY  greaterThan_altfp_compare_38b IS 
	 PORT 
	 ( 
		 agb	:	OUT  STD_LOGIC;
		 clock	:	IN  STD_LOGIC;
 ...
 END greaterThan_altfp_compare_38b;

 ARCHITECTURE RTL OF greaterThan_altfp_compare_38b IS
 ...
 END RTL; --greaterThan_altfp_compare_38b
--VALID FILE
...
ARCHITECTURE RTL OF greaterthan IS

	SIGNAL sub_wire0	: STD_LOGIC ;



	COMPONENT greaterThan_altfp_compare_38b
	PORT (
			agb	: OUT STD_LOGIC ;
			clock	: IN STD_LOGIC ;
			dataa	: IN STD_LOGIC_VECTOR (31 DOWNTO 0);
...
BEGIN
	...
	greaterThan_altfp_compare_38b_component : greaterThan_altfp_compare_38b
	PORT MAP (
		clock => clock,
		dataa => dataa,
		datab => datab,
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL greaterThan.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL greaterThan.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL greaterThan.cmp FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL greaterThan.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL greaterThan_inst.vhd FALSE
